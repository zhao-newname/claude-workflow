...
### 6. Update Active Task Tracker
**IMPORTANT**: Update `.claude/ACTIVE_TASK.md` with:
- Current progress percentage (calculate from tasks.md)
- Updated timestamp
- Current state summary (extract from context.md)
- Quick resume information (what was just completed, what's next)
- This file is critical for resuming work after context reset
