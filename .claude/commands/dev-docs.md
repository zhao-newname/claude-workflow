...
6. **Create/Update Active Task Tracker**:
   - Create or update `.claude/ACTIVE_TASK.md` with:
     - Task name and path
     - Status: "进行中" (In Progress)
     - Progress: 0%
     - Last updated timestamp
     - Quick resume guide pointing to the three files above
     - Current state summary (brief overview of what needs to be done)
   - Use the template structure from `src/templates/ACTIVE_TASK.md.template` if available
